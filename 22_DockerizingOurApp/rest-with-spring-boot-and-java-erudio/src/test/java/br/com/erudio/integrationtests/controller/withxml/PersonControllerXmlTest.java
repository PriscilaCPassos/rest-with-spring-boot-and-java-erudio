...
public class PersonControllerXmlTest extends AbstractIntegrationTest{
    ...
    public void testFindAll() throws JsonMappingException, JsonProcessingException {
        ...
        assertEquals("Charin", foundPersonOne.getFirstName());
        assertEquals("Elbourn", foundPersonOne.getLastName());
        assertEquals("6 Chive Court", foundPersonOne.getAddress());
        ...
        assertEquals("Mehetabel", foundPersonSix.getFirstName());
        assertEquals("Hugues", foundPersonSix.getLastName());
        assertEquals("440 Bultman Parkway", foundPersonSix.getAddress());
    ...
    public void testFindByName() throws JsonMappingException, JsonProcessingException {
        ...
        assertEquals("Larissa", foundPersonOne.getFirstName());
